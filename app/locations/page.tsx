...
export default function LocationsPage() {
  ...
  return (
    <>
      <DynamicMetadata page="locations" />
      <ModernNavbar />
      <main className="flex min-h-screen flex-col items-center justify-between pt-20">
        ...
        >
          <motion.div className="max-w-7xl mx-auto">
            <h1 className="text-5xl font-pizza font-bold mb-8 text-center text-primary">Find Our Locations</h1>
            <p className="text-xl text-center mb-12 max-w-3xl mx-auto">
              We have pizza restaurants across the country. Use the map below to find the location nearest to you.
            </p>
            
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <motion.div className="lg:col-span-2 relative w-full min-h-[500px]">
              ...
              <motion.div className="bg-gray-100 rounded-lg p-6 shadow-lg">
                ...
                <div className="h-[420px] overflow-y-auto pr-2 fancy-scrollbar">
